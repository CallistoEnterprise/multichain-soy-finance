...
import { Flex, Text, Link, Heading } from '@callisto-enterprise/soy-uikit2'
  ...
  return (
    <StyledBetDetails>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Link href={getCallistoExpLink(bet.round.lockBlock, 'block')} external>
          {bet.round.lockBlock}
        </Link>
      </Flex>
      <Flex alignItems="center" justifyContent="space-between">
        <Text>{t('Closing Block')}</Text>
        <Link href={getCallistoExpLink(bet.round.endBlock, 'block')} external>
          {bet.round.endBlock}
        </Link>
      </Flex>
    </StyledBetDetails>
