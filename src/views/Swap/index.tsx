...
import { CurrencyAmount, JSBI, Token, Trade } from '@soy-libs/sdk-multichain'
import { Button, Text, ArrowDownIcon, Box, useModal } from '@soy-libs/uikit2'
...
const StyledLink = styled.a`
  ...
  border: 1px solid ${({ theme }) => theme.colors.btnPrimaryBk};
  margin-top: 30px;
`
