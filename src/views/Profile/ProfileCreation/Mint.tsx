...
import { Card, CardBody, Heading, Text } from '@callisto-enterprise/soy-uikit2'
import { useWeb3React } from '@web3-react/core'
import { useTranslation } from 'contexts/Localization'
import useApproveConfirmTransaction from 'hooks/useApproveConfirmTransaction'
import { DEFAULT_TOKEN_DECIMAL } from 'config'
import { usePmoon, useBunnyFactory } from 'hooks/useContract'
...
const Mint: React.FC = () => {
  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {t('You can change your profile pic later if you get another approved Polysafemoon Collectible.')}
      </Text>
      <Card mb="24px">
        <CardBody>
