...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@callisto-enterprise/soy-uikit2'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% SOY', { cost: getBalanceNumber(numberCakeToReactivate) })}
      </Text>
