...
import { Button, Flex, Text, InjectedModalProps } from '@callisto-enterprise/soy-uikit2'
import { getFullDisplayBalance } from 'utils/formatBalance'
import { getPancakeProfileAddress } from 'utils/addressHelpers'
import { usePmoon } from 'hooks/useContract'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  /**
   * Check if the wallet has the required SOY allowance to change their profile pic or reactivate
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!hasMinimumCakeRequired &&
            t('%minimum% SOY required to change profile pic', { minimum: getFullDisplayBalance(minimumCakeRequired) })}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>
