...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useModal, useMatchBreakpoints } from '@soy-libs/uikit2'
...
const EarningsCell: React.FC<EarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  // Auto SOY vault calculations
  const {
    userData: { pmoonAtLastUserAction, userShares, lastUserActionTime },
    pricePerFullShare,
  } = useCakeVault()
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoCakeToDisplay} decimals={3} bold unit=" SOY" />
