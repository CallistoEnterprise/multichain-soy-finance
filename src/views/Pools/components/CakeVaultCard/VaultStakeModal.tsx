...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from '@callisto-enterprise/soy-uikit2'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({ pool, stakingMax, isRemovingStake = false, onDismiss }) => {
  ...
  const handleWithdrawal = async (convertedStakeAmount: BigNumber) => {
    ...
    // trigger withdrawAll function if the withdrawal will leave 0.000001 SOY or less
