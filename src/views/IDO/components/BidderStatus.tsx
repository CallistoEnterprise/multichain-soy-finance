      ...
      <AutoColumn>
        <AutoRow justify="space-between">
          <AutoColumn justify="space-between">
            ...
            <Text fontSize="24px" mt="5px" color="primary">
              {item.unlockDate === 0 ? '-' : item.soyAmount.toFixed(2)} SOY
            </Text>
            <Text fontSize="12px" mt="-5px" color="primary">
              Bonus: {bonus} SOY
            </Text>
          </AutoColumn>
          <Line />
          ...
          <AutoColumn justify="space-between">
            <Text fontSize="14px" textAlign="end">
              {item.unlockDate === 0 ? '-' : prevSoyPrice === 0 ? 0 : prevSoyPrice.toFixed(6)} USD
            </Text>
            <Text fontSize="14px" mt="5px" textAlign="end">
              {date}
            </Text>
          </AutoColumn>
        </AutoRow>
