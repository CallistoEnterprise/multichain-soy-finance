...
import { BlockIcon, CheckmarkCircleIcon, Flex, Link, OpenNewIcon, RefreshIcon } from '@callisto-enterprise/soy-uikit2'
...
const TransactionRow: React.FC<TransactionRowProps> = ({ txn }) => {
  ...
  return (
    <TxnLink href={getCallistoExpLink(txn.hash, 'transaction', chainId)} external>
