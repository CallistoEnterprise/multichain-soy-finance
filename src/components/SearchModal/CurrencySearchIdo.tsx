...
import { ChainId, Currency, ETHERS, Token } from 'sdk'
  ...
  return (
    <>
      <div>
        ...
        ) : filteredSortedTokens1?.length > 0 || filteredInactiveTokens?.length > 0 ? (
          <Box margin="24px -24px">
            <CurrencyList
              height={390}
              showETH={showETH}
              currencies={
                filteredInactiveTokens ? filteredSortedTokens1.concat(filteredInactiveTokens) : filteredSortedTokens1
              }
              breakIndex={inactiveTokens && filteredSortedTokens1 ? filteredSortedTokens1.length : undefined}
...
export default CurrencySearchIdo
