...
export const GRAPH_API_LOTTERY = 'https://graphql.callisto.network/testnet/subgraphs/name/SoyFinance/lottery/graphql' //process.env.REACT_APP_GRAPH_API_LOTTERY
