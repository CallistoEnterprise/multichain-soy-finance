...
export const useCakeVault = () => {
  const {
    ...
    userData: {
      ...
      pmoonAtLastUserAction: pmoonAtLastUserActionAsString,
      lastDepositedTime,
      lastUserActionTime,
    },
  ...
  const pmoonAtLastUserAction = useMemo(() => {
    return new BigNumber(pmoonAtLastUserActionAsString)
  }, [pmoonAtLastUserActionAsString])
