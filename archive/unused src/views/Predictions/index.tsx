...
import { useMatchBreakpoints, useModal } from '@callisto-enterprise/soy-uikit2'
...
const Predictions = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, {
    localStorageKey: 'polysafemoon_predictions_accepted_risk',
  })
  const [hasAcceptedChart, setHasAcceptedChart] = usePersistState(false, {
    localStorageKey: 'polysafemoon_predictions_chart',
  })
