...
import { CardBody, Text, Flex, BlockIcon, LinkExternal } from '@callisto-enterprise/soy-uikit2'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://docs.polysafemoon.finance/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
