...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'SOY card' },
    { src: 'green', alt: 'Green SOY card with up arrow' },
    { src: 'red', alt: 'Red SOY card with down arrow' },
    { src: 'top-right', alt: 'SOY card' },
  ],
}
