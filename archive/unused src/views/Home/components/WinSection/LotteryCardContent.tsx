...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from '@callisto-enterprise/soy-uikit2'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%SOYPrizeInUsd% in SOY prizes this round', { SOYPrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with SOY, win SOY if your numbers match')}
        </Text>
      </Flex>
